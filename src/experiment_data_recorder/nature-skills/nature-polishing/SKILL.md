...
The main strategy should come from the section architecture and writing principles in this skill.
The reference wording layer should come from `Academic Phrasebank` via the bundled reference files.
