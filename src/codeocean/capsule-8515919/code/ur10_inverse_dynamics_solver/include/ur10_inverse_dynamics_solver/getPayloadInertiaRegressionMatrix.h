 ...
 * that the torques due to inertia effects, when the robot is holding
...
// File: getPayloadInertiaRegressionMatrix.h
//
...
namespace ur10 {
extern void getPayloadInertiaRegressionMatrix(const double in1[6], const double in2[10], double payload_inertia_regression_matrix[36]);

}

//
// File trailer for getPayloadInertiaRegressionMatrix.h
//
// [EOF]
//
