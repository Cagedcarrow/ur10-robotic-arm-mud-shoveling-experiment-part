...
# --- Import RealSenseRecorder from sibling package ---
...
class RealSenseAdapter:
    """Thin wrapper around RealSenseRecorder for mud experiment recording."""
    ...
    def get_latest_preview(self) -> Tuple[Optional[np.ndarray], Optional[np.ndarray]]:
        """Return (rgb_bgr, depth_bgr) latest frames for GUI preview."""
