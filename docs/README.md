...
这里是 `/root/ur10_ws/docs` 的主入口页，适合在 GitHub 中作为文档总导航使用。

## 新手推荐阅读顺序

如果你是第一次接触 ROS 2、MoveIt2 或 Gazebo，推荐按下面顺序阅读：

1. [ROS 2 入门与本项目上手指南](07_ros2_getting_started.md)
2. [运行手册](03_runbook.md)
3. [工作区结构说明](02_workspace_structure.md)
4. [节点与 Launch 清单](04_nodes_and_launches.md)
...
- [01 编译与重编指南](01_build_and_rebuild_guide.md)
- [02 工作区结构说明](02_workspace_structure.md)
- [03 运行手册](03_runbook.md)
- [04 节点与 Launch 清单](04_nodes_and_launches.md)
