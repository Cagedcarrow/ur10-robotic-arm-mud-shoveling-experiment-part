...
: ${AMENT_CURRENT_PREFIX:="/root/ur10_ws/install/ur10_simulation_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur10_simulation_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur10_simulation_bringup/environment/path.sh"
