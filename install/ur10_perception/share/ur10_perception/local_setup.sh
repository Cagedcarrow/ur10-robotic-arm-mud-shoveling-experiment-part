...
: ${AMENT_CURRENT_PREFIX:="/root/ur10_ws/install/ur10_perception"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur10_perception/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur10_perception/environment/path.sh"
